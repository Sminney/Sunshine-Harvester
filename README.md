...
<html xml:lang="EN" xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		...
		<style type="text/css"> #myContainer { width:2048px; height:1080px; margin:auto; border:1px; border-style:solid; border-color:#696969;} </style>
		<script type="text/javascript"> Z.showImage("myContainer", "nma.img-ci20102510-476-wm-vs2"); </script>
	</head>
	<body bgcolor=#000000>
		<br>
